...
#[inline]
pub unsafe extern "C" fn mi_page_thread_free_flag(
...
#[inline]
pub unsafe extern "C" fn mi_page_set_heap(
...
#[inline]
pub unsafe extern "C" fn mi_page_set_has_aligned(
    mut page: *mut mi_page_t,
...
pub unsafe extern "C" fn mi_stat_free(
    mut page: *const mi_page_t,
    mut block: *const mi_block_t,
) {
...
#[inline(never)]
pub unsafe extern "C" fn mi_try_new(
    mut size: size_t,
    mut nothrow: bool,
) -> *mut libc::c_void {
...
#[inline]
pub unsafe extern "C" fn mi_bitmap_index_bit_in_field(
...
pub unsafe extern "C" fn mi_heap_collect_ex(
    mut heap: *mut mi_heap_t,
...
pub unsafe extern "C" fn mi_out_stderr(
    mut msg: *const libc::c_char,
    mut arg: *mut libc::c_void,
) {
    if !msg.is_null()
...
pub unsafe extern "C" fn mi_out_buf(
    mut msg: *const libc::c_char,
    mut arg: *mut libc::c_void,
) {
    if msg.is_null() {
...
pub unsafe extern "C" fn mi_page_queue_of(
    mut page: *const mi_page_t,
) -> *mut mi_page_queue_t {
...
pub unsafe extern "C" fn mi_page_to_full(
    mut page: *mut mi_page_t,
    mut pq: *mut mi_page_queue_t,
) {
...
pub unsafe extern "C" fn mi_random_init_ex(
    mut ctx: *mut mi_random_ctx_t,
    mut use_weak: bool,
) {
...
pub unsafe extern "C" fn mi_pages_try_purge(
    mut force: bool,
    mut tld: *mut mi_segments_tld_t,
) {
    if mi_option_get(mi_option_purge_delay) < 0 as libc::c_int as libc::c_long {
...
pub unsafe extern "C" fn mi_segment_raw_page_size(
    mut segment: *const mi_segment_t,
) -> size_t {
...
pub unsafe extern "C" fn mi_stat_update(
...
pub unsafe extern "C" fn mi_stats_add(
    mut stats: *mut mi_stats_t,
...
pub unsafe extern "C" fn mi_buffered_out(
    mut msg: *const libc::c_char,
    mut arg: *mut libc::c_void,
) {
